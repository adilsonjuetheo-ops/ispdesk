          ...
          return (
            <button key={c.id} onClick={() => handleSelecionar(c)}
              className={clsx(
                ...
                !ativa && slaExcedido(c) && 'bg-red-50 border-l-[3px] border-l-red-500',
              ...
              <div className="relative shrink-0 mt-0.5">
                ...
                {/* Badge WhatsApp */}
                <span className="absolute -bottom-1.5 -right-1.5 w-[28px] h-[20px] bg-[#25D366] rounded-[7px] border-2 border-white flex items-center justify-center shadow">
